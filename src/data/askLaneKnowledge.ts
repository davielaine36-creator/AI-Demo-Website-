...
export const ASK_LANE_KNOWLEDGE: KnowledgeChunk[] = [
  ...
  // ── Process, agreements & industry guidance ────────────────────────────
  // Honest process/context — Ask Laine explains how things work, never gives
  // legal advice or claims a contract guarantees/protects anything.
  {
    id: 'written-agreement-before-work',
    title: 'Written agreement before work starts',
    category: 'Working Together',
    keywords: [
      'contract',
      'agreement',
    ...
    content:
      'Before a real project starts, Laine Industries should confirm the scope, price, timeline, responsibilities, and payment terms in writing. This protects both sides. The agreement is not meant to make the process scary; it makes sure everyone understands what is being built, what is included, what is not included, and what happens after launch. For anything legal-heavy, clients should review final terms with an attorney. Ask Laine can explain the general process, but it should not give legal advice or replace a signed agreement.',
    relatedLinks: [LINKS.intake, LINKS.contact],
  },
  {
    id: 'deposit-before-work',
    title: 'Deposit before build work',
    category: 'Working Together',
    keywords: [
      'deposit',
      'payment',
  ...
  {
    id: 'proposal-quote-signoff-process',
    title: 'Proposal, quote, and sign-off process',
    category: 'Working Together',
    keywords: [
      'proposal',
      'quote',
    ...
    content:
      'The usual process is simple: first, Laine Industries learns what is messy or manual in the business. Then we recommend the simplest useful starting system. After that, we provide a proposal with the problem, recommended scope, deliverables, rough timeline, price, client responsibilities, and what is not included. The client reviews and approves the proposal before work starts. A proposal is not a blank check for unlimited changes; it is the agreed starting plan.',
    relatedLinks: [LINKS.howItWorks, LINKS.intake],
  },
  {
    id: 'client-kickoff-onboarding',
    title: 'Client kickoff and onboarding',
    category: 'Working Together',
    keywords: [
      'kickoff',
      'onboarding',
    ...
    content:
      'After a client says yes, the kickoff is where Laine Industries collects the basics needed to build correctly. This usually includes business name, services, contact info, logo or photos if available, current website or domain details, examples of forms or messages, who should receive alerts, and what success looks like. If access is needed, we prefer collaborator invites, temporary access, or a guided setup call. Clients should not text passwords, API keys, payment info, or sensitive customer data.',
    relatedLinks: [LINKS.intake, LINKS.fullIntake],
  },
  {
    id: 'handoff-deliverables',
    title: 'What clients receive at handoff',
    category: 'Working Together',
    keywords: [
      'handoff',
      'deliverables',
  ...
  {
    id: 'response-time-availability',
    title: 'Response time and availability',
    category: 'Monthly Support',
    keywords: [
      'response time',
      'support hours',
  ...
  {
    id: 'pass-through-tool-costs',
    title: 'Third-party tool costs',
    category: 'Pricing',
    keywords: [
      'tool costs',
      'hosting costs',
    ...
    content:
      'Some systems can run with very low outside tool costs. Others may need paid services for hosting, email sending, databases, forms, automation, storage, or higher usage. These are third-party costs, separate from Laine Industries’ build or support fee unless the proposal says they are included. The clean rule is: no surprise expensive tools. If a paid tool is needed, Laine Industries should explain the reason, the rough cost, and whether the client pays it directly or it is passed through.',
    relatedLinks: [LINKS.intake, LINKS.services],
  },
  {
    id: 'third-party-platform-limits',
    title: 'Limits of third-party platforms',
    category: 'Privacy & Security',
    keywords: [
      'platform down',
      'hosting outage',
  ...
  {
    id: 'contractor-trades-starting-point',
    title: 'Best starting point for contractors and trades',
    category: 'Demos & Examples',
    keywords: [
      'contractor',
      'trades',
    ...
    content:
      'For contractors and trades, the best starting point is usually a clear website or landing page plus a quote request form and simple lead tracker. The goal is to make it easy for a customer to explain what they need, then make sure the business owner can see the lead, follow up, and move it toward an estimate or scheduled job. Avoid overbuilding at first. Most contractors do not need a huge custom app on day one; they need fewer missed leads and clearer follow-up.',
    relatedLinks: [LINKS.smallBusinesses, LINKS.intake],
  },
  {
    id: 'training-school-starting-point',
    title: 'Best starting point for training or certification businesses',
    category: 'Demos & Examples',
    keywords: [
      'training',
      'school',
    ...
    content:
      'For a training school or certification business, the best starting point is usually a clear website, class or service explanation, intake/interest form, and a simple way to track prospective students. If the business has recurring classes, reminders and follow-up become important. The system should help people understand what course they need, submit their information, and receive the next step. Over time, this can grow into scheduling, reminders, requalification tracking, or student follow-up.',
    relatedLinks: [LINKS.smallBusinesses, LINKS.intake],
  },
  {
    id: 'cleaning-window-service-starting-point',
    title: 'Best starting point for cleaning or window service businesses',
    category: 'Demos & Examples',
    keywords: [
      'cleaning',
      'window',
    ...
    content:
      'For cleaning, window service, or similar local service businesses, the first useful system is often a quote request flow plus a simple follow-up process. Customers usually want to know price, availability, and how to schedule. A good system collects the right details, alerts the owner, keeps the lead organized, and reminds the business to follow up. This helps prevent leads from getting buried in texts, missed calls, or scattered notes.',
    relatedLinks: [LINKS.smallBusinesses, LINKS.intake],
  },
  {
    id: 'shopify-store-starting-point',
    title: 'Best starting point for Shopify or ecommerce stores',
    category: 'Services',
    keywords: [
      'shopify',
      'ecommerce',
    ...
    content:
      'For a Shopify or ecommerce store, the best starting point depends on the current problem. If the store feels unclear, start with product pages, trust, and customer experience. If operations are messy, start with order tracking, customer follow-up, or simple dashboarding. If marketing is the issue, focus on email capture, customer segments, and repeat purchase flows. Laine Industries should avoid promising revenue results. The first goal is usually better clarity, better organization, and cleaner follow-up.',
    relatedLinks: [LINKS.services, LINKS.intake],
  },
  {
    id: 'solo-service-provider-starting-point',
    title: 'Best starting point for solo service providers',
    category: 'Demos & Examples',
    keywords: [
      'solo',
      'freelancer',
    ...
    content:
      'For a solo service provider, the best starting point is usually a simple website, clear offer, contact or intake form, and a lightweight follow-up process. The system should make the provider easier to understand and easier to contact without adding complexity. If the provider is managing everything alone, monthly support may be useful so they do not have to manage hosting, updates, forms, or technical fixes themselves.',
    relatedLinks: [LINKS.smallBusinesses, LINKS.intake],
  },
  {
    id: 'client-readiness-checklist',
    ...
    content:
      'Before starting, a client should prepare the basics: business name, contact information, services or offers, logo and photos if available, current website or domain information, examples of current forms or messages, and a clear description of what happens when a new lead comes in. It also helps to know who should receive alerts, what tools the business already uses, and what success would look like. The client does not need to know the technical answer; they just need to explain the current process.',
    relatedLinks: [LINKS.intake, LINKS.fullIntake],
  },
  {
    id: 'intake-questionnaire-purpose',
    title: 'Why the intake questionnaire matters',
    category: 'Next Steps',
    keywords: [
      'intake',
      'questionnaire',
    ...
    content:
      'The intake questionnaire helps Laine Industries avoid guessing. It gives enough context to understand the business, current process, pain points, tools, timeline, and likely starting system. A short intake is usually enough for an early conversation. A full intake is better when the business wants a website, dashboard, automation, or follow-up system with more moving parts. The intake does not lock the client into a project; it helps create a useful recommendation and clearer proposal.',
    relatedLinks: [LINKS.intake, LINKS.fullIntake],
  },
  {
    id: 'contracts-attorney-review',
    title: 'Contracts and attorney review',
    category: 'Working Together',
    keywords: [
      'contract',
      'lawyer',
  ...
  // ── Follow-up topics (revisions, delays, maintenance, domains, migration, refunds, SEO) ──
  {
    id: 'revisions-and-change-requests',
    ...
    content:
      'Laine Industries should include a clear revision process in the proposal so both sides know how feedback works. Small edits that fit the approved scope are usually handled during the build or review period. Bigger changes, new pages, new features, or a different direction may change the timeline and price. The goal is not to nickel-and-dime clients; it is to keep the project clear and avoid unlimited open-ended work. Final revision terms should be confirmed in the proposal or written agreement.',
    relatedLinks: [LINKS.howItWorks, LINKS.intake],
  },
  {
    id: 'client-delays-and-approvals',
    title: 'Client delays and approvals',
    category: 'Working Together',
    keywords: [
      'delay',
      'approval',
    ...
    content:
      'Project timelines depend on both sides. Laine Industries can build faster when the client provides business details, content, access, approvals, and feedback on time. If key materials are missing — like domain access, service details, photos, logo files, or approval on a draft — the timeline may shift. That does not mean the project is failing; it means the schedule depends on the information needed to build correctly. Any important timeline changes should be communicated clearly.',
    relatedLinks: [LINKS.howItWorks, LINKS.intake],
  },
  {
    id: 'maintenance-vs-new-features',
    title: 'Maintenance vs new features',
    category: 'Monthly Support',
    keywords: [
      'maintenance',
      'support',
    ...
    content:
      'Monthly support is usually for keeping the agreed system running smoothly, answering reasonable questions, making small updates, and helping with issues inside the support scope. New features are different. A new page, new dashboard, new automation, new integration, or major redesign may need a separate quote or mini-project. This keeps monthly support useful without turning it into unlimited development. The support plan should explain what is included, what is not included, and how new requests are handled.',
    relatedLinks: [LINKS.services, LINKS.contact],
  },
  {
    id: 'domains-and-business-email',
    title: 'Domains and business email',
    category: 'Services',
    keywords: [
      'domain',
      'business email',
    ...
    content:
      'Laine Industries can help clients understand the basics of domains, DNS, hosting, and business email, but ownership and billing should stay clear. A domain is the website address, and business email is often handled through a provider like Google Workspace or another email service. Setup can be guided or included if it is part of the project scope. Third-party costs, renewals, and provider limits are separate unless the proposal says otherwise. Clients should never send passwords in normal messages.',
    relatedLinks: [LINKS.services, LINKS.intake],
  },
  {
    id: 'migration-from-existing-tools',
    title: 'Migration from existing websites or tools',
    category: 'Services',
    keywords: [
      'migrate',
      'move website',
    ...
    content:
      'If a client already has a website, spreadsheet, CRM, form, Shopify store, or other tool, Laine Industries can review it and recommend the cleanest path forward. Sometimes the right answer is to improve what already exists. Other times, it is cleaner to rebuild a simple version that works better. Migration depends on access, platform limits, current setup, data quality, and the final scope. Laine Industries should not promise that every old tool or record can be moved perfectly without first reviewing the setup.',
    relatedLinks: [LINKS.services, LINKS.intake],
  },
  {
    id: 'refunds-and-cancellations-process',
    ...
    content:
      'Refunds, cancellations, and paused projects should be handled according to the written proposal or agreement. Ask Laine can explain the general process, but it should not promise a refund, cancellation right, or legal outcome. Before work starts, the client should understand the payment schedule, deposit, what happens if the project is paused, and what is delivered at each stage. If there is a disagreement, the written agreement and a qualified professional should guide the next step.',
    relatedLinks: [LINKS.contact, LINKS.intake],
  },
  {
    id: 'basic-seo-and-accessibility',
    title: 'Basic SEO and accessibility expectations',
    category: 'Services',
    keywords: [
      'seo',
      'google ranking',
    ...
    content:
      'Laine Industries can include basic website best practices such as clear page structure, readable copy, titles, descriptions, mobile-friendly layouts, and simple accessibility-minded choices. That can help a site feel more trustworthy and usable. However, Laine Industries should not guarantee Google rankings, traffic, legal accessibility compliance, or SEO results. If a client needs formal accessibility compliance, legal review, or advanced SEO strategy, that should be scoped separately with the right specialist.',
    relatedLinks: [LINKS.services, LINKS.contact],
  },
]
